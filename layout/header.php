    ...
    <div class="container">
      ...
      <div id="navbar" class="navbar-collapse collapse">
        <ul class="nav navbar-nav navbar-right">
          ...
          <li><a href="<?php echo $url ?>menu.php">Menu Layanan</a></li>
          ...
          <?php if (!empty($_SESSION['iam_user'])) { ?>
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li><a href="<?php echo $url ?>riwayat_pembelian.php">Riwayat Pembelian</a></li>
      ...
      <header id="myCarousel" class="carousel slide">
        ...
        <div class="carousel-inner">
          <div class="item active">
            ...
            <div class="fill" style="background-image:url('<?php $url ?>assets/img/banner1.jpg');"></div>
            <div class="carousel-caption">
            </div>
          </div>
          <div class="item">
            <!-- Set the second background image using inline CSS below. -->
            <div class="fill" style="background-image:url('<?php $url ?>assets/img/banner.jpg');"></div>
            <div class="carousel-caption">
            </div>
          </div>
        </div>
